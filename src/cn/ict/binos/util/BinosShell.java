 ...
 * 
 * <code>BinosShell</code> can be used to run unix commands like <code>du</code> or
 * <code>df</code>. It also offers facilities to gate commands by 
 * time-intervals.
 */

abstract public class BinosShell {
  
  public static final Log LOG = LogFactory.getLog(BinosShell.class);
   ...
   *        command.
   */
  public BinosShell( long interval ) {
  ...
  private void runCommand() throws IOException { 
    ...
    BinosShellTimeoutTimerTask timeoutTimerTask = null;
    ...
    if (timeOutInterval > 0) {
      ...
      timeoutTimerTask = new BinosShellTimeoutTimerTask(
          this);
      //One time scheduling.
   ...
   */
  public static class BinosShellCommandExecutor extends BinosShell {
    
    private String[] command;
    private StringBuffer output;
    
    
    public BinosShellCommandExecutor(String[] execString) {
      this(execString, null);
    }
    
    public BinosShellCommandExecutor(String[] execString, File dir) {
  ...
  public static String execCommand(Map<String, String> env, String[] cmd,
    ...
    BinosShellCommandExecutor exec = new BinosShellCommandExecutor(cmd, null, env, 
                                                          timeout);
    exec.execute();
   ...
   */
  private static class BinosShellTimeoutTimerTask extends TimerTask {

    private BinosShell shell;

    public BinosShellTimeoutTimerTask(BinosShell shell) {
      this.shell = shell;
    }
